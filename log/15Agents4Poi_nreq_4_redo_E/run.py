...
def run():
    experiment_name = "15Agents4Poi_nreq_4_redo_E"
    n_stats_run_per_process = 1


    mods_to_mix = [
        (global_reward, difference_reward),
        (mean_fitness_critic, none, flat_critic_6_etb, monte_flat_critic_5_etb )
    ]
...
if __name__ == '__main__':
    # r = Runner('test', (global_reward, mean_fitness_critic))
    # r.new_run()
